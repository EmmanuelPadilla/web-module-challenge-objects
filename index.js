...
console.log (createMenuItem('tacos', 15, 'lunch'))
console.log (createMenuItem('pozole', 10, 'breakfast'))
console.log (createMenuItem('quesadillas', 12, 'lunch'))
...
console.log(reviews[2].feedback);
...
console.log(addReview(reviews, 'Emmanuel', 4.5, 'I would definately go back to this place. It was awesome'));

// /* Task 5: Add the following feedback to Reyna's rating - "this place is chill with really cool people, great for getting work done on weekdays"

function changeReview (array, index, feedback){
  array[index].review = feedback;
  return array;
}
